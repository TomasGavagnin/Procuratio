...
{
    public class ClsDatosEstadisticasReservas
    {
        /// <summary>
        ...
        /// <returns></returns>
        public DataTable ArticulosMasVendidosReserva(string _FechaDesde, string _FechaHasta, ClsCategoriasArticulos.EParaCocina _ParaCocina, ref string _InformacionDelError)
        {
            ...
            try
            {
                ...
                SqlDataAdapter EjecutarConculta = new SqlDataAdapter("SP_ArticulosMasVendidosReserva", Conexion);
        ...
        /// <param name="_InformacionDelError"></param>
        /// <returns></returns>
        public DataTable ArticulosMenosVendidosReserva(string _FechaDesde, string _FechaHasta, ClsCategoriasArticulos.EParaCocina _ParaCocina, ref string _InformacionDelError)
        {
            SqlConnection Conexion = null;
            ...
            try
            {
                ...
                SqlDataAdapter EjecutarConculta = new SqlDataAdapter("SP_ArticulosMenosVendidosReserva", Conexion);
        ...
        public DataTable ArticulosMasVendidosCategoriaReserva(string _FechaDesde, string _FechaHasta, ref string _InformacionDelError)
        {
            SqlConnection Conexion = null;
            ...
            try
            {
                ...
                SqlDataAdapter EjecutarConculta = new SqlDataAdapter("SP_ArticulosMasVendidosCategoriaReserva", Conexion);
        ...
        public DataTable ArticulosMenosVendidosCategoriaReserva(string _FechaDesde, string _FechaHasta, ref string _InformacionDelError)
        {
            SqlConnection Conexion = null;
            ...
            try
            {
                ...
                SqlDataAdapter EjecutarConculta = new SqlDataAdapter("SP_ArticulosMenosVendidosCategoriaReserva", Conexion);
        ...
        public DataTable ArticulosVendidosPorMesReserva(int _Año, ref string _InformacionDelError)
        {
            SqlConnection Conexion = null;
            ...
            try
            {
                ...
                SqlDataAdapter EjecutarConculta = new SqlDataAdapter("SP_ArticulosVendidosPorMesReserva", Conexion);
