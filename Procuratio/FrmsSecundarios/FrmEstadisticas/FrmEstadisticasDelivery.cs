...
{
    public partial class FrmEstadisticasDelivery : Form
    {
        #region Carga
        private FrmEstadisticasDelivery()
        {
            InitializeComponent();
        }

        private void FrmEstadisticasDelivery_Load(object sender, EventArgs e)
        {
        ...
        private void CargarChtArticulosMasVendidosCocina()
        {
            ...
            TablaDeDatos = DatosEstadisticasDeliveries.ArticulosMasVendidosDelivery(FechaDesde, FechaHasta, ClsCategoriasArticulos.EParaCocina.Si, ref InformacionDelError);
        ...
        private void CargarChtArticulosMasVendidosNoCocina()
        {
            ...
            ClsDatosEstadisticasDeliveries DatosEstadisticasDeliveries = new ClsDatosEstadisticasDeliveries();
            TablaDeDatos = DatosEstadisticasDeliveries.ArticulosMasVendidosDelivery(FechaDesde, FechaHasta, ClsCategoriasArticulos.EParaCocina.No, ref InformacionDelError);
        ...
        private void CargarChtArticulosMenosVendidosCocina()
        {
            ...
            ClsDatosEstadisticasDeliveries DatosEstadisticasDeliveries = new ClsDatosEstadisticasDeliveries();
            TablaDeDatos = DatosEstadisticasDeliveries.ArticulosMenosVendidosDelivery(FechaDesde, FechaHasta, ClsCategoriasArticulos.EParaCocina.Si, ref InformacionDelError);
        ...
        private void CargarChtArticulosMenosVendidosNoCocina()
        {
            ...
            ClsDatosEstadisticasDeliveries DatosEstadisticasDeliveries = new ClsDatosEstadisticasDeliveries();
            TablaDeDatos = DatosEstadisticasDeliveries.ArticulosMenosVendidosDelivery(FechaDesde, FechaHasta, ClsCategoriasArticulos.EParaCocina.No, ref InformacionDelError);
        ...
        private void CargarChtArticulosMasVendidosCategoria()
        {
            ...
            ClsDatosEstadisticasDeliveries DatosEstadisticasDeliveries = new ClsDatosEstadisticasDeliveries();
            TablaDeDatos = DatosEstadisticasDeliveries.ArticulosMasVendidosCategoriaDelivery(FechaDesde, FechaHasta, ref InformacionDelError);
        ...
        #region Variables
        private static FrmEstadisticasDelivery InstanciaForm;
        #endregion
        ...
        /// </summary>
        /// <returns></returns>
        public static FrmEstadisticasDelivery ObtenerInstancia()
        {
            if (InstanciaForm == null) { InstanciaForm = new FrmEstadisticasDelivery(); }
