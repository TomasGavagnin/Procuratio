...
{
    public partial class FrmEstadisticasReservas : Form
    {
        #region Carga
        private FrmEstadisticasReservas()
        {
            InitializeComponent();
        }

        private void FrmEstadisticasReservas_Load(object sender, EventArgs e)
        {
        ...
        private void CargarChtArticulosMasVendidosCocina()
        {
            ...
            ClsDatosEstadisticasReservas DatosEstadisticasReservas = new ClsDatosEstadisticasReservas();
            TablaDeDatos = DatosEstadisticasReservas.ArticulosMasVendidosReserva(FechaDesde, FechaHasta, ClsCategoriasArticulos.EParaCocina.Si, ref InformacionDelError);
        ...
        private void CargarChtArticulosMasVendidosNoCocina()
        {
            ...
            ClsDatosEstadisticasReservas DatosEstadisticasReservas = new ClsDatosEstadisticasReservas();
            TablaDeDatos = DatosEstadisticasReservas.ArticulosMasVendidosReserva(FechaDesde, FechaHasta, ClsCategoriasArticulos.EParaCocina.No, ref InformacionDelError);
        ...
        private void CargarChtArticulosMenosVendidosCocina()
        {
            ...
            ClsDatosEstadisticasReservas DatosEstadisticasReservas = new ClsDatosEstadisticasReservas();
            TablaDeDatos = DatosEstadisticasReservas.ArticulosMenosVendidosReserva(FechaDesde, FechaHasta, ClsCategoriasArticulos.EParaCocina.Si, ref InformacionDelError);
        ...
        private void CargarChtArticulosMenosVendidosNoCocina()
        {
            ...
            ClsDatosEstadisticasReservas DatosEstadisticasReservas = new ClsDatosEstadisticasReservas();
            TablaDeDatos = DatosEstadisticasReservas.ArticulosMenosVendidosReserva(FechaDesde, FechaHasta, ClsCategoriasArticulos.EParaCocina.No, ref InformacionDelError);
        ...
        private void CargarChtArticulosMasVendidosCategoria()
        {
            ...
            ClsDatosEstadisticasReservas DatosEstadisticasReservas = new ClsDatosEstadisticasReservas();
            TablaDeDatos = DatosEstadisticasReservas.ArticulosMasVendidosCategoriaReserva(FechaDesde, FechaHasta, ref InformacionDelError);
        ...
        private void CargarChtArticulosMenosVendidosCategoria()
        {
            ...
            ClsDatosEstadisticasReservas DatosEstadisticasReservas = new ClsDatosEstadisticasReservas();
            TablaDeDatos = DatosEstadisticasReservas.ArticulosMenosVendidosCategoriaReserva(FechaDesde, FechaHasta, ref InformacionDelError);
        ...
        private void CargarChtArticulosVendidosPorMes()
        {
            ...
            ClsDatosEstadisticasReservas DatosEstadisticasReservas = new ClsDatosEstadisticasReservas();
            TablaDeDatos = DatosEstadisticasReservas.ArticulosVendidosPorMesReserva((int)nudAño.Value, ref InformacionDelError);
        ...
        #region Variables
        private static FrmEstadisticasReservas InstanciaForm;
        #endregion
        ...
        /// </summary>
        /// <returns></returns>
        public static FrmEstadisticasReservas ObtenerInstancia()
        {
            if (InstanciaForm == null) { InstanciaForm = new FrmEstadisticasReservas(); }
